...
export default function About() {
  ...
  return (
    <>
    <Navbar />
    <main className="p-6 max-w-2xl mx-auto bg-white dark:bg-gray-900 rounded transition-colors duration-300">
      ...
      <div className="space-y-2">
        <a
            ...
            className="flex items-center gap-2 text-blue-600 dark:text-blue-400 underline cursor-pointer"
        >
